<?php
	...
	if(isset($_POST["topo"])) { 
		...
		$requete_topo = "UPDATE chapitre_12 SET topo_theorique = '$topo' WHERE id_cha12 = 12";
		$result = pg_query($dbconn, $requete_topo);
	}

	if(isset($_POST["synthese"])) { 
		$synthese = htmlspecialchars($_POST["synthese"], ENT_QUOTES); 
		$requete_synthese = "UPDATE chapitre_12 SET synthese = '$synthese' WHERE id_cha12 = 12";
	...
	if(isset($_POST["question_expert_1"])) { 
		...
		//echo $question_expert_1;
		$requete_question_expert_1 = "UPDATE chapitre_12 SET avis_expert_rep_q1 = '$question_expert_1' WHERE id_cha12 = 12";
		//echo $requete_question_expert_1;
	...
	if(isset($_POST["question_expert_2"])) { 
		...
		$requete_question_expert_2 = "UPDATE chapitre_12 SET avis_expert_rep_q2 = '$question_expert_2' WHERE id_cha12 = 12";
	...
	if(isset($_POST["cas_pratique"])) { 
		...
		$requete_cas_pratique = "UPDATE chapitre_12 SET donnees_cas = '$cas_pratique' WHERE id_cha12 = 12";
	...
	if(isset($_POST["reponse_cas_pratique"])) { 
		...
		$requete_reponse_cas_pratique = "UPDATE chapitre_12 SET reponse_cas_QCM = '$reponse_cas_pratique' WHERE id_cha12 = 12";
	...
	if(isset($_POST["axes_reflexions_1"])) { 
		...
		$requete_axes_reflexions_1 = "UPDATE chapitre_12 SET axes_reflex_rep_q1 = '$axes_reflexions_1' WHERE id_cha12 = 12";
	...
	if (!$result) {
		...
		header("Location:chapitre12.php");
	}