<?php
	...
	if(isset($_POST["topo"])) { 
		...
		$requete_topo = "UPDATE chapitre_03 SET topo_theorique = '$topo' WHERE id_cha3 = 3";
		$result = pg_query($dbconn, $requete_topo);
	}

	if(isset($_POST["synthese"])) { 
		$synthese = htmlspecialchars($_POST["synthese"], ENT_QUOTES); 
		$requete_synthese = "UPDATE chapitre_03 SET synthese = '$synthese' WHERE id_cha3 = 3";
	...
	if(isset($_POST["question_expert"])) { 
		...
		$requete_question_expert = "UPDATE chapitre_03 SET avis_expert_rep_q1 = '$question_expert' WHERE id_cha3 = 3";
	...
	if(isset($_POST["cas_pratique"])) { 
		...
		$requete_cas_pratique = "UPDATE chapitre_03 SET donnees_cas = '$cas_pratique' WHERE id_cha3 = 3";
	...
	if(isset($_POST["reponse_cas_pratique"])) { 
		...
		$requete_reponse_cas_pratique = "UPDATE chapitre_03 SET reponse_cas_QCM = '$reponse_cas_pratique' WHERE id_cha3 = 3";
	...
	if(isset($_POST["axes_reflexions"])) { 
		...
		$requete_axes_reflexions = "UPDATE chapitre_03 SET axes_reflex_rep_q1 = '$axes_reflexions' WHERE id_cha3 = 3";
	...
	if (!$result) {
		...
		header("Location:chapitre03.php");
	}
