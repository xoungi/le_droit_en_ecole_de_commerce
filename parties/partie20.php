...
<html lang="fr">
	...
	<body>
		<?php
			...
			$requete = "SELECT partie_1, categorie_a, categorie_b FROM chapitre_10";
		...
		<hr /><h3> I - La détermination de la faute dans la responsabilité pour faute (responsabilité subjective)</h3>
		<?php
			if ($partie_1 != "") {
		...
		<?php } ?>
		<h4><u> B - Les diverses manifestations de la faute</u></h4>			
		<?php
			if ($categorie_b != "") {
