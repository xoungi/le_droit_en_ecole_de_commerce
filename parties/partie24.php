...
<html lang="fr">
	...
	<body>
		<?php
			...
			$requete = "SELECT partie_1, categorie_a, categorie_b FROM chapitre_12";
		...
		<hr /><h3> I - Des rapprochements au-delà des distinctions</h3>					
		<?php
			if ($partie_1 != "") {
		...
		<?php } ?>
		<h4><u> A - Une vocation commune au-delà d'objectifs différents : la régulation des comportements ou l'incitation à éviter les comportements dommageables (la fonction normative)</u></h4>						
		<?php
			if ($categorie_a != "") {
		...
		<?php } ?>
		<h4><u> B - Une reconnaissance liée : la responsabilité pénale des personnes morales</u></h4>						
		<?php
			if ($categorie_b != "") {
