<?php // parties 11, 12
	...
	if(isset($_POST["partie_1"])) { 
		...
		$requete_partie_1 = "UPDATE chapitre_06 SET partie_1 = '$partie_1' WHERE id_cha6 = 6";
	...
	if(isset($_POST["categorie_a"])) { 
		...
		$requete_categorie_a = "UPDATE chapitre_06 SET categorie_a = '$categorie_a' WHERE id_cha6 = 6";
	...
	if(isset($_POST["souscategorie_1"])) { 
		...
		$requete_souscategorie_1 = "UPDATE chapitre_06 SET souscategorie_1 = '$souscategorie_1' WHERE id_cha6 = 6";
	...
	if(isset($_POST["souscategorie_2"])) { 
		...
		$requete_souscategorie_2 = "UPDATE chapitre_06 SET souscategorie_2 = '$souscategorie_2' WHERE id_cha6 = 6";
	...
	if(isset($_POST["categorie_b"])) { 
		...
		$requete_categorie_b = "UPDATE chapitre_06 SET categorie_b = '$categorie_b' WHERE id_cha6 = 6";
		$result = pg_query($dbconn, $requete_categorie_b);
	}

	if(isset($_POST["partie_2"])) { 
		$partie_2 = htmlspecialchars($_POST["partie_2"], ENT_QUOTES); 
		$requete_partie_2 = "UPDATE chapitre_06 SET partie_2 = '$partie_2' WHERE id_cha6 = 6";
	...
	if(isset($_POST["categorie_c"])) { 
		...
		$requete_categorie_c = "UPDATE chapitre_06 SET categorie_c = '$categorie_c' WHERE id_cha6 = 6";
	...
	if(isset($_POST["categorie_d"])) { 
		...
		$requete_categorie_d = "UPDATE chapitre_06 SET categorie_d = '$categorie_d' WHERE id_cha6 = 6";
	...
	if(isset($_POST["souscategorie_3"])) { 
		...
		$requete_souscategorie_3 = "UPDATE chapitre_06 SET souscategorie_3 = '$souscategorie_3' WHERE id_cha6 = 6";
	...
	if(isset($_POST["souscategorie_4"])) { 
		...
		$requete_souscategorie_4 = "UPDATE chapitre_06 SET souscategorie_4 = '$souscategorie_4' WHERE id_cha6 = 6";
	...
	if(isset($_POST["conclusion"])) { 
		...
		$requete_conclusion = "UPDATE chapitre_06 SET conclusion = '$conclusion' WHERE id_cha6 = 6";
	...
	if (!$result) {
		...
		header("Location:../chapitres/chapitre06.php");
	}