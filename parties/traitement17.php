<?php // parties 34, 35
	...
	if(isset($_POST["partie_1"])) { 
		...
		$requete_partie_1 = "UPDATE chapitre_17 SET partie_1 = '$partie_1' WHERE id_cha17 = 17";
	...
	if(isset($_POST["categorie_a"])) { 
		...
		$requete_categorie_a = "UPDATE chapitre_17 SET categorie_a = '$categorie_a' WHERE id_cha17 = 17";
	...
	if(isset($_POST["categorie_b"])) { 
		...
		$requete_categorie_b = "UPDATE chapitre_17 SET categorie_b = '$categorie_b' WHERE id_cha17 = 17";
	...
	if(isset($_POST["souscategorie_1"])) { 
		...
		$requete_souscategorie_1 = "UPDATE chapitre_17 SET souscategorie_1 = '$souscategorie_1' WHERE id_cha17 = 17";
	...
	if(isset($_POST["souscategorie_2"])) { 
		...
		$requete_souscategorie_2 = "UPDATE chapitre_17 SET souscategorie_2 = '$souscategorie_2' WHERE id_cha17 = 17";
	...
	if(isset($_POST["branche_a"])) { 
		...
		$requete_branche_a = "UPDATE chapitre_17 SET branche_a = '$branche_a' WHERE id_cha17 = 17";
		$result = pg_query($dbconn, $requete_branche_a);
	}

	if(isset($_POST["branche_b"])) { 
		$branche_b = htmlspecialchars($_POST["branche_b"], ENT_QUOTES); 
		$requete_branche_b = "UPDATE chapitre_17 SET branche_b = '$branche_b' WHERE id_cha17 = 17";
		$result = pg_query($dbconn, $requete_branche_b);
	}

	if(isset($_POST["branche_c"])) { 
		$branche_c = htmlspecialchars($_POST["branche_c"], ENT_QUOTES); 
		$requete_branche_c = "UPDATE chapitre_17 SET branche_c = '$branche_c' WHERE id_cha17 = 17";
	...
	if(isset($_POST["partie_2"])) { 
		...
		$requete_partie_2 = "UPDATE chapitre_17 SET partie_2 = '$partie_2' WHERE id_cha17 = 17";
	...
	if(isset($_POST["categorie_c"])) { 
		...
		$requete_categorie_c = "UPDATE chapitre_17 SET categorie_c = '$categorie_c' WHERE id_cha17 = 17";
	...
	if(isset($_POST["souscategorie_3"])) { 
		...
		$requete_souscategorie_3 = "UPDATE chapitre_17 SET souscategorie_3 = '$souscategorie_3' WHERE id_cha17 = 17";
	...
	if(isset($_POST["souscategorie_4"])) { 
		...
		$requete_souscategorie_4 = "UPDATE chapitre_17 SET souscategorie_4 = '$souscategorie_4' WHERE id_cha17 = 17";
	...
	if(isset($_POST["souscategorie_5"])) { 
		...
		$requete_souscategorie_5 = "UPDATE chapitre_17 SET souscategorie_5 = '$souscategorie_5' WHERE id_cha17 = 17";
	...
	if(isset($_POST["categorie_d"])) { 
		...
		$requete_categorie_d = "UPDATE chapitre_17 SET categorie_d = '$categorie_d' WHERE id_cha17 = 17";
	...
	if(isset($_POST["souscategorie_6"])) { 
		...
		$requete_souscategorie_6 = "UPDATE chapitre_17 SET souscategorie_6 = '$souscategorie_6' WHERE id_cha17 = 17";
	...
	if(isset($_POST["souscategorie_7"])) { 
		...
		$requete_souscategorie_7 = "UPDATE chapitre_17 SET souscategorie_7 = '$souscategorie_7' WHERE id_cha17 = 17";
	...
	if(isset($_POST["conclusion"])) { 
		...
		$requete_conclusion = "UPDATE chapitre_17 SET conclusion = '$conclusion' WHERE id_cha17 = 17";
	...
	if (!$result) {
		...
		header("Location:../chapitres/chapitre17.php");
	}