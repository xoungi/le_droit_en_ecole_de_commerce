...
<html lang="fr">
	...
	<body>
		<?php
			...
			$requete = "SELECT partie_1, categorie_a, categorie_b FROM chapitre_09";
		...
		<hr /><h3> I - L'exploitation du nom</h3>		
		<?php
			if ($partie_1 != "") {
		...
		<?php } ?>
		<h4><u> B - Certains contrats portant sur le nom sont possibles</u></h4>
		<?php
			if ($categorie_b != "") {
