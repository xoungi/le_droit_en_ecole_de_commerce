...
<html lang="fr">
	...
	<body>
		<?php
			...
			$requete = "SELECT partie_2, categorie_c, categorie_d, souscategorie_3, souscategorie_4, conclusion FROM chapitre_06";
		...
		<hr /><h3> II - Médiation et arbitrage dans les litiges internationaux</h3>		
		<?php
			if ($partie_2 != "") {
