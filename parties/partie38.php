...
<html lang="fr">
	...
	<body>
		<?php
			...
			$requete = "SELECT partie_1, categorie_a, categorie_b FROM chapitre_19";
		...
		<hr /><h3> I - La notion de groupe de contrats </h3>					
		<?php
			if ($partie_1 != "") {
		...
		<?php } ?>
		<h4><u> B - Le fondement juridique de la notion de groupe de contrats</u></h4>						
		<?php
			if ($categorie_b != "") {
