...
<html lang="fr">
	...
	<body>
		<?php
			...
			$requete = "SELECT partie_2, categorie_c, categorie_d, conclusion FROM chapitre_11";
		...
		<hr /><h3> II - La loi n°2002-303 du 4 mars 2002 relative aux droits des malades et à la qualité du système de santé, dite loi Kouchner et la loi n° 2002-1577 du 30 décembre 2002 relative à la responsabilité civile médicale </h3>					
		<?php
			if ($partie_2 != "") {
