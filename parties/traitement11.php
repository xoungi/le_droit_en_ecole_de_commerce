<?php // parties 22, 23
	...
	if(isset($_POST["partie_1"])) { 
		...
		$requete_partie_1 = "UPDATE chapitre_11 SET partie_1 = '$partie_1' WHERE id_cha11 = 11";
	...
	if(isset($_POST["categorie_a"])) { 
		...
		$requete_categorie_a = "UPDATE chapitre_11 SET categorie_a = '$categorie_a' WHERE id_cha11 = 11";
	...
	if(isset($_POST["categorie_b"])) { 
		...
		$requete_categorie_b = "UPDATE chapitre_11 SET categorie_b = '$categorie_b' WHERE id_cha11 = 11";
		$result = pg_query($dbconn, $requete_categorie_b);
	}

	if(isset($_POST["partie_2"])) { 
		$partie_2 = htmlspecialchars($_POST["partie_2"], ENT_QUOTES); 
		$requete_partie_2 = "UPDATE chapitre_11 SET partie_2 = '$partie_2' WHERE id_cha11 = 11";
	...
	if(isset($_POST["categorie_c"])) { 
		...
		$requete_categorie_c = "UPDATE chapitre_11 SET categorie_c = '$categorie_c' WHERE id_cha11 = 11";
	...
	if(isset($_POST["categorie_d"])) { 
		...
		$requete_categorie_d = "UPDATE chapitre_11 SET categorie_d = '$categorie_d' WHERE id_cha11 = 11";
	...
	if(isset($_POST["conclusion"])) { 
		...
		$requete_conclusion = "UPDATE chapitre_11 SET conclusion = '$conclusion' WHERE id_cha11 = 11";
	...
	if (!$result) {
		...
		header("Location:../chapitres/chapitre11.php");
	}