<?php // parties 18, 19
	...
	if(isset($_POST["partie_1"])) { 
		...
		$requete_partie_1 = "UPDATE chapitre_09 SET partie_1 = '$partie_1' WHERE id_cha9 = 9";
	...
	if(isset($_POST["categorie_a"])) { 
		...
		$requete_categorie_a = "UPDATE chapitre_09 SET categorie_a = '$categorie_a' WHERE id_cha9 = 9";
	...
	if(isset($_POST["categorie_b"])) { 
		...
		$requete_categorie_b = "UPDATE chapitre_09 SET categorie_b = '$categorie_b' WHERE id_cha9 = 9";
		$result = pg_query($dbconn, $requete_categorie_b);
	}

	if(isset($_POST["partie_2"])) { 
		$partie_2 = htmlspecialchars($_POST["partie_2"], ENT_QUOTES); 
		$requete_partie_2 = "UPDATE chapitre_09 SET partie_2 = '$partie_2' WHERE id_cha9 = 9";
	...
	if(isset($_POST["categorie_c"])) { 
		...
		$requete_categorie_c = "UPDATE chapitre_09 SET categorie_c = '$categorie_c' WHERE id_cha9 = 9";
	...
	if(isset($_POST["categorie_d"])) { 
		...
		$requete_categorie_d = "UPDATE chapitre_09 SET categorie_d = '$categorie_d' WHERE id_cha9 = 9";
	...
	if (!$result) {
		...
		header("Location:../chapitres/chapitre09.php");
	}