...
<html lang="fr">
	...
	<body>
		<?php
			...
			$requete = "SELECT partie_1, categorie_a, categorie_b FROM chapitre_18";
		...
		<hr /><h3> I - Le choix du créancier face à l'inexécution contractuelle </h3>					
		<?php
			if ($partie_1 != "") {
		...
		<?php } ?>
		<h4><u> B - La résolution pour inexécution</u></h4>						
		<?php
			if ($categorie_b != "") {
