...
<html lang="fr">
	...
	<body>
		<?php
			...
			$requete = "SELECT partie_1, categorie_a, categorie_b FROM chapitre_15";
		...
		<hr /><h3> I - Conditions relatives à la personne du contractant</h3>					
		<?php
			if ($partie_1 != "") {
		...
		<?php } ?>
		<h4><u> B - L'intégrité du consentement</u></h4>						
		<?php
			if ($categorie_b != "") {
