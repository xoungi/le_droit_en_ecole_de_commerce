<?php // parties 1, 2
	...
	if(isset($_POST["partie_1"])) { 
		...
		$requete_partie_1 = "UPDATE chapitre_01 SET partie_1 = '$partie_1' WHERE id_cha1 = 1";
	...
	if(isset($_POST["categorie_a"])) { 
		...
		$requete_categorie_a = "UPDATE chapitre_01 SET categorie_a = '$categorie_a' WHERE id_cha1 = 1";
	...
	if(isset($_POST["souscategorie_1"])) { 
		...
		$requete_souscategorie_1 = "UPDATE chapitre_01 SET souscategorie_1 = '$souscategorie_1' WHERE id_cha1 = 1";
	...
	if(isset($_POST["souscategorie_2"])) { 
		...
		$requete_souscategorie_2 = "UPDATE chapitre_01 SET souscategorie_2 = '$souscategorie_2' WHERE id_cha1 = 1";
	...
	if(isset($_POST["souscategorie_3"])) { 
		...
		$requete_souscategorie_3 = "UPDATE chapitre_01 SET souscategorie_3 = '$souscategorie_3' WHERE id_cha1 = 1";
	...
	if(isset($_POST["categorie_b"])) { 
		...
		$requete_categorie_b = "UPDATE chapitre_01 SET categorie_b = '$categorie_b' WHERE id_cha1 = 1";
	...
	if(isset($_POST["souscategorie_4"])) { 
		...
		$requete_souscategorie_4 = "UPDATE chapitre_01 SET souscategorie_4 = '$souscategorie_4' WHERE id_cha1 = 1";
	...
	if(isset($_POST["souscategorie_5"])) { 
		...
		$requete_souscategorie_5 = "UPDATE chapitre_01 SET souscategorie_5 = '$souscategorie_5' WHERE id_cha1 = 1";
		$result = pg_query($dbconn, $requete_souscategorie_5);
	}	

	if(isset($_POST["branche_1"])) { 
		$branche_1 = htmlspecialchars($_POST["branche_1"], ENT_QUOTES); 
		$requete_branche_1 = "UPDATE chapitre_01 SET branche_1 = '$branche_1' WHERE id_cha1 = 1";
		$result = pg_query($dbconn, $requete_branche_1);
	}

	if(isset($_POST["branche_2"])) { 
		$branche_2 = htmlspecialchars($_POST["branche_2"], ENT_QUOTES); 
		$requete_branche_2 = "UPDATE chapitre_01 SET branche_2 = '$branche_2' WHERE id_cha1 = 1";
		$result = pg_query($dbconn, $requete_branche_2);
	}

	if(isset($_POST["partie_2"])) { 
		$partie_2 = htmlspecialchars($_POST["partie_2"], ENT_QUOTES); 
		$requete_partie_2 = "UPDATE chapitre_01 SET partie_2 = '$partie_2' WHERE id_cha1 = 1";
	...
	if(isset($_POST["categorie_c"])) { 
		...
		$requete_categorie_c = "UPDATE chapitre_01 SET categorie_c = '$categorie_c' WHERE id_cha1 = 1";
	...
	if(isset($_POST["souscategorie_6"])) { 
		...
		$requete_souscategorie_6 = "UPDATE chapitre_01 SET souscategorie_6 = '$souscategorie_6' WHERE id_cha1 = 1";
	...
	if(isset($_POST["souscategorie_7"])) { 
		...
		$requete_souscategorie_7 = "UPDATE chapitre_01 SET souscategorie_7 = '$souscategorie_7' WHERE id_cha1 = 1";
	...
	if(isset($_POST["categorie_d"])) { 
		...
		$requete_categorie_d = "UPDATE chapitre_01 SET categorie_d = '$categorie_d' WHERE id_cha1 = 1";
	...
	if(isset($_POST["souscategorie_8"])) { 
		...
		$requete_souscategorie_8 = "UPDATE chapitre_01 SET souscategorie_8 = '$souscategorie_8' WHERE id_cha1 = 1";
	...
	if(isset($_POST["souscategorie_9"])) { 
		...
		$requete_souscategorie_9 = "UPDATE chapitre_01 SET souscategorie_9 = '$souscategorie_9' WHERE id_cha1 = 1";
	...
	if(isset($_POST["conclusion"])) { 
		...
		$requete_conclusion = "UPDATE chapitre_01 SET conclusion = '$conclusion' WHERE id_cha1 = 1";
	...
	if (!$result) {
		...
		header("Location:../chapitres/chapitre01.php");
	}